...
def own_problems(request):
    ...
    new_problems = problem_list.filter (status__exact = "new")
    ...
    context_dict = {'new_problems': new_problems,'pending_problems': pending_problems, 'in_progress_problems': in_progress_problems, 'solved_problems': solved_problems}
